...
g.apply(this);a?b.fadeOut(a,function(){b.remove()}):b.remove()},open:function(a){g.apply(this).fadeIn(a)},disable:function(){g.apply(this).on("click",function(a){a.preventDefault()})},enable:function(){g.apply(this).off("click")}};b.fn.urlive=function(a){if(h[a])return h[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof a&&a)b.error('Method "'+a+'" does not exist on jquery.urlive');else return h.init.apply(this,arguments)}})(jQuery);